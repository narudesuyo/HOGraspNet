...
def main(cfg):
    ...
    if "class_weight" in cfg_copy.train:
        del cfg_copy.train.class_weights
    ...
    for epoch in range(cfg.train.num_epochs):
        if epoch == cfg.model.unfreeze_img_enc_epoch:
            for param in img_enc.parameters():
                param.requires_grad = True
            print("Unfrozen img_enc")
        ...
        for batch in train_pbar:
            ...
            wandb.log({'epoch': epoch + 1, 'batch_train_loss': loss.item(), 'batch_train_acc': acc})
